...
def augment_none(x, y, y_mask, x_aug, y_aug, y_mask_aug, i, vocab_size, unk_token):
    """
...
def augment_substitute(x, y, y_mask, x_aug, y_aug, y_mask_aug, i, vocab_size, unk_token):
    """
...
def augment_insert(x, y, y_mask, x_aug, y_aug, y_mask_aug, i, vocab_size, unk_token):
    """
...
def augment_delete(x, y, y_mask, x_aug, y_aug, y_mask_aug, i, vocab_size, unk_token):
    """
...
def augment_all(x, y, y_mask, x_aug, y_aug, y_mask_aug, i, vocab_size, unk_token=0):
    """
    ...
    r = np.random.rand()
    if r < alpha_sub:
        augment_substitute(x, y, y_mask, x_aug, y_aug, y_mask_aug, i, vocab_size, unk_token)
    elif r < alpha_sub + alpha_del:
        augment_delete(x, y, y_mask, x_aug, y_aug, y_mask_aug, i, vocab_size, unk_token)
    else:
        augment_insert(x, y, y_mask, x_aug, y_aug, y_mask_aug, i, vocab_size, unk_token)
